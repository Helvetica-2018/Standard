...
class Ioc
{
    ...
    public function newClass($className)
    {
        ...
        $dependent = new Dependent($this->container, $className);
        $this->container[$className] = $dependent;
        return $dependent;
    }
     ...
     */
    protected function getReflectionParameters(Reflector $reflection, $inherentNumber)
    {
